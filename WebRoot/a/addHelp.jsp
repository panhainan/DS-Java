		...
		<div class="right">
			<div class="newToic" align="center">
				...
				<form id="newT" method="post" onsubmit="return validAnno()"
					action="help_ManageAdd.action">
					<div class="titleStyle" align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;发布论坛帮助:</div>
					<div class="newStyle">
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td>标题：<input type="text" name="thelp.title" id="tTitle"
							...
							<tr>
								<td width="700px"><textarea id="content"
										style="display: none;" name="thelp.content"></textarea> <script
										id="container" type="text/plain"></script></td>
								<script type="text/javascript">
