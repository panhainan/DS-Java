	...
	<div class="background">
		...
		<div class="newToic" align="center">
			...
			<form id="newT" method="post" onsubmit="return validAnno()"
				action="anno_ManageUpdate.action">
				<div class="titleStyle" align="left">
					更新论坛公告:
					<s:property value="announce.title" />
				</div>
				<div class="newStyle">
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<th width="150px" align="center">文章标题</th>
							<td><input type="text" name="announce.title" id="tTitle"
								onkeyup="showLen(this);"
								value="<s:property value="announce.title" />"
								style="width: 600px;height: 26px;line-height: 24px;font-size: 14px;padding-left: 6px;"
								maxlength="50" /><span id="span"
								style="color:red;font-size:14px"> 您还可以输入50个字符</span><input
								type="text" name="announce.id" style="display: none;"
								value="<s:property value="announce.id" />"
								 /></td>
						</tr>
						<tr>
							...
							<td width="700px"><textarea id="content"
								...
								<script id="container" type="text/plain"><s:property value="announce.announcement" escape="false" /></script>
							</td>
							<script type="text/javascript">
