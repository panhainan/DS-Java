		...
		<div class="tbody">
			...
			<div>
					...
					<s:iterator value="pageBean">
						...
						<s:elseif test="%{totalPages == 2}">
							<s:if test="currentPage==1">
								<button disabled="disabled" style="width: 80px;">上一页</button>
								<button disabled="disabled">1</button>
								<a href="topic_GetNiceTopic.action?nowPage=2"><button>2</button>
								</a>
								<a
									href="topic_GetNiceTopic.action?nowPage=<s:property value="%{currentPage+1}"/>"><button
							...
							<s:elseif test="currentPage==2">
								...
								<a href="topic_GetNiceTopic.action?nowPage=1"><button>1</button>
								</a>
						...
						<s:elseif test="%{totalPages == 3}">
							<s:if test="currentPage==1">
								...
								<a href="topic_GetNiceTopic.action?nowPage=3"><button>3</button>
								</a>
								<a
									href="topic_GetNiceTopic.action?nowPage=<s:property value="%{currentPage+1}"/>"><button
										style="width: 80px;">下一页</button> </a>
						...
						<s:elseif test="%{totalPages > 3}">
							<s:if test="%{currentPage==1}">
								...
								<a
									href="topic_GetNiceTopic.action?nowPage=<s:property value="%{totalPages}" />"><button>
							...
							<s:elseif test="%{currentPage==totalPages}">
								...
								<a><button disabled="disabled">...</button> </a>
								<a
									href="topic_GetNiceTopic.action?nowPage=<s:property value="%{totalPages-1}" />"><button>
				...
				<div class="pageGo" align="right">
					<form action="topic_GetNiceTopic.action" method="post"
						name="goPageForm">
